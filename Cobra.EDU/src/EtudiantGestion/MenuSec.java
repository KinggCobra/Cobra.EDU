 ...
 * @author ASUS
 */
public class MenuSec extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuSec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
